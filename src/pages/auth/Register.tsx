...
export default function Register() {
  ...
  async function onRegister() {
    ...
    if (!email || !password || !username) { setErr('Заполни все поля'); return }
    ...
    // If sign-in is successful, go to family setup
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-[#F8F9FF] to-[#EDF2FF] px-6">
      ...
      <div className="w-full max-w-sm flex flex-col items-center mt-20">
        <h1 className="text-3xl font-extrabold text-center text-black mb-8">Регистрация</h1>
        <form className="w-full space-y-4">
          ...
          <div className="relative">
            ...
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 text-xl pointer-events-none">
              {/* User icon */}
              <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="8" r="4" stroke="#A3A3A3" strokeWidth="2"/><path d="M4 20v-2a8 8 0 0 1 16 0v2" stroke="#A3A3A3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
            </span>
          </div>
          <div className="relative">
            <input
